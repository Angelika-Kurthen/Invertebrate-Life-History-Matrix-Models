...
source("Scripts/A_sp_Temp_Toggle.R")
source("Scripts/Bsp_Temp_Toggle.R")
source("Scripts/CspTempToggle.R")
source("Scripts/D_sp_TempToggle.R")
...
source("Scripts/A_sp_Fecundity_Toggle.R")
source("Scripts/B_sp_fecundity_toggle.R")
source("Scripts/C_sp_FecundityToggle.R")
source("Scripts/D_sp_Fecundity_Toggle.R")
